...
const DarkColors = {
  ...
  tabBarBorder: 'rgba(91, 138, 106, 0.15)',
  tabBarActive: '#5B8A6A',
  ...
  cardBackground: '#162119',
  backgroundDark: '#000000',
  backgroundDeep: '#050505',
  backgroundElevated: '#1A2B1F',
  inputBackground: '#162119',
